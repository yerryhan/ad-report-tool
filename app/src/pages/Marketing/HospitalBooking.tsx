...
export default function HospitalBooking() {
  ...
  // 2단일 때만 왼쪽 차트를 65%→60%로 줄여 리스트 폭을 넓히고 단 사이 여백을 확보한다.
  const LIST_FRAME_H = 600;        // 차트 높이(px)
  const LIST_TWO_COL_MIN = 18;     // 이 개수 이상이면 2단
  ...
  return (
    <>
      ...
      <div className="h-full flex flex-col">
        ...
        {/* 컨텐츠 — 전체 흰색 배경 + 사방 32px(p-8) 여백 규칙 */}
        <div className="flex-1 overflow-auto bg-white dark:bg-gray-800 font-nanum p-8">
